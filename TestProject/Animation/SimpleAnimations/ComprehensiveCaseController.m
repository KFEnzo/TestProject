...
-(void)dingdingAnimation{
    ...
    if (!_dingdingAnimationMenu) {
        ...
        DWBubbleMenuButton *upMenuView = [[DWBubbleMenuButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - homeLabel.frame.size.width - 20.f,
                                                                                              self.view.frame.size.height - UINavigationBarHeight - homeLabel.frame.size.height - 20.f,
...
-(void)clickGoodAnimation{
    ...
    if (!_goodBtn) {
        _goodBtn = [[MCFireworksButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2-25, (SCREEN_HEIGHT-UINavigationBarHeight)/2-25, 50, 50)];
