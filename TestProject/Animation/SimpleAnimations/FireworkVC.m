...
@interface FireworkVC ()
/** <#注释#> */
@property (nonatomic, readwrite, strong) CAEmitterLayer *caELayer;
@end

@implementation FireworkVC
...
- (void)setupFireworks {
    ...
    cell.contents = (id)[[UIImage imageNamed:@"congratulations_icon"] CGImage];
//    UIImage *image1 = [[UIImage imageWithColor:[UIColor randomColor] size:CGSizeMake(30, 30)] hq_circleImage];
//    cell.contents = (id)[image1 CGImage];
    // 缩放比例
    cell.scale = 0.2;
    // 粒子的颜色
    ...
    // 是个CGImageRef的对象,既粒子要展现的图片
    spark.contents = (id)
    [[UIImage imageNamed:@"congratulations_icon"] CGImage];
//    UIImage *image2 = [[UIImage imageWithColor:[UIColor randomColor] size:CGSizeMake(5, 5)] hq_circleImage];
