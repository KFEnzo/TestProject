...
@interface GroupAnimationController ()<UIGestureRecognizerDelegate>
...
-(void)initView{
    ...
    _demoView = [[UIView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2-25, (SCREEN_HEIGHT  - UINavigationBarHeight)/2-50,50,50)];
